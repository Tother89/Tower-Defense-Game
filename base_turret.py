...
import pygame, sys, bmpfont, effects
...
class Base_Unit(Sprite):
    ...
    damage_font = bmpfont.BitmapFont("images/healthfont.png", 6, 7, 48)
    ...
    def get_unit_at_pos(pos):
        ...
        is present.
        """
        for u in Base_Unit.active_units:
    ...
    def _update_image(self):
        ...
        # Render the damage.
        damage_surf = Base_Unit.damage_font.render(str(int(self.damage)))
        
        # Move the damage to the bottom-right of the image.
        image_rect = self.image.get_rect()
        damage_rect = damage_surf.get_rect()
        damage_rect.move_ip(image_rect.w - damage_rect.w,
                            image_rect.h - damage_rect.h)
                            
        # Draw the damage on to the image.
        self.image.blit(damage_surf, health_rect)
    ...
    def is_attackable(self, from_tile, from_pos, to_tile, to_pos):
        ...
        u = Base_Unit.get_unit_at_pos(to_pos)
